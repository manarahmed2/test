class TopScorers {
  ...
  late final int playerName;
  late final List<Scorer> playerGoals;
  
  TopScorers.fromJson(Map<String, dynamic> json){
    playerName = json['playerName'];
    playerGoals = List.from(json['playerGoals']).map((e) => Scorer.fromJson(e)).toList();
  }

  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['playerName'] = playerName;
    _data['playerGoals'] = playerGoals.map((e) => e.toJson()).toList();
    return _data;
  }
}
